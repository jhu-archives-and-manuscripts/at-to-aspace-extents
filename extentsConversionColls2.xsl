...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- LJD20160329: This stylesheet starts with the XML file located at "G:\archives-and-manuscripts\aspace\concatenateColls.xml" and generates a 
        ...
        The resulting XML file is located at: "G:\archives-and-manuscripts\aspace\extentsStatement.xml".-->
    
    <xsl:strip-space elements="*"/>
    <xsl:output method="xml" version="1.1" encoding="UTF-8" indent="yes"/>
    
    <xsl:template match="/">
        <xsl:result-document href="file:/G:/archives-and-manuscripts/aspace/extentsStatement.xml">
            <collections>
            <xsl:for-each-group select="/collections/Query1" group-by="Call_No">
                <collection>
                    <collectionNumber>
