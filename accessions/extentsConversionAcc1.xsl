<?xml version="1.1" encoding="UTF-8"?>
 <xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- LJD20160323: This stylesheet is used to generate a simple XML file concatinating by collection and listing basic extents information from 
        ...
        The resulting XML file is located at: "G:\archives-and-manuscripts\aspace\concatenateCollsAcc.xml".-->
    
    <xsl:strip-space elements="*"/>
    <xsl:output method="xml" version="1.1" encoding="UTF-8" indent="yes"/>
     
     <xsl:template match="/">
         <xsl:result-document href="file:/G:/archives-and-manuscripts/aspace/concatenateCollsAcc.xml">
             <collections>
         <xsl:for-each-group select="dataroot/Query2" group-by="Call_No">
             <Query2>
                 <Call_No>
